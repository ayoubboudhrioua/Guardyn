...
if not HOST.startswith("http"):
    HOST = "http://" + HOST
MODEL = os.environ.get("ISNAD_JUDGE_MODEL", "qwen3:8b")
ENABLED = os.environ.get("ISNAD_LLM", "on").lower() not in ("off", "0", "false")
BUDGET_S = float(os.environ.get("ISNAD_LLM_BUDGET_S", "2.5"))
