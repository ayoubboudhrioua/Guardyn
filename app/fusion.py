...
WEIGHTS = {
    ...
    "COMMITTEE_SPLIT": 0.0,
    # Guardyn-Flow
    "SENSITIVE_TO_UNLICENSED_SINK": 0.93,
    "SENSITIVE_IN_REPLY": 0.85,
    "SENSITIVE_IN_RECORD": 0.85,
    "SENSITIVE_IN_MEMORY": 0.80,
    "ENCODED_EXFIL": 0.93,
    "CALL_BUDGET_EXCEEDED": 0.55,
    "COUNTERFACTUAL_DIVERGENCE": 0.65,
    "TASK_MISALIGNED": 0.30,
}
